...
#include "drone_msgs/msg/detail/marker_pose__rosidl_typesupport_fastrtps_c.h"
...
using _MarkerPose__ros_msg_type = drone_msgs__msg__MarkerPose;
...
static uint32_t _MarkerPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_msgs__msg__MarkerPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_msgs__msg__MarkerPose;
    is_plain =
      (
...
static size_t _MarkerPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_msgs__msg__MarkerPose(
